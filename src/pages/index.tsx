  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine - Streamlining your dining experience by allowing you to reserve tables and empowering restaurant employees to manage reservations and menus efficiently."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine - Streamlining your dining experience by allowing you to reserve tables and empowering restaurant employees to manage reservations and menus efficiently.`}
            </Text>
            <Box
